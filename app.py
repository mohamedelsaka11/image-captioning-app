...
def main():
    ...
    if uploaded_image is not None :
        ...
        model_path = "D:/Projects Ds/Image Captioning/model.keras"  # Replace with the actual path
        tokenizer_path = "D:/Projects Ds\Image Captioning/tokenizer.pkl"  # Replace with the actual path
        feature_extractor_path = "D:/Projects Ds\Image Captioning/feature_extractor.keras"  # Replace with the actual path
